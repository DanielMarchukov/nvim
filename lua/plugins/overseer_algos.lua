...
overseer.register_template({
  ...
  builder = function()
    return {
      ...
      args = {
        "spring-boot:run",
        "-Dspring-boot.run.mainClass=org.solidus.clientstore.SolidusClientStoreApplication",
      },
      env = {
        AWS_DEFAULT_OUTPUT = "json",
        AWS_DEFAULT_REGION = "us-east-2",
      ...
      cwd = vim.fn.expand("~") .. "/workspace/solidus-client-store",
      name = "Client Store",
      components = { "default" },
    }
  end,
...
overseer.register_template({
  ...
  builder = function()
    return {
      ...
      args = {
        "spring-boot:run",
        "-Dspring-boot.run.mainClass=org.solidus.currency.converter.SolidusCurrencyConverterApplication",
      },
      env = {
        AWS_DEFAULT_OUTPUT = "json",
        AWS_DEFAULT_REGION = "us-east-2",
      ...
      cwd = vim.fn.expand("~") .. "/workspace/solidus-currency-converter",
      name = "Currency Converter",
      components = { "default" },
    }
  end,
